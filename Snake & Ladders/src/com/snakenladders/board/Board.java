...
public final class Board
{
	...
	public Board()
	{
		...
		//Board-Building
		for (int i = 0; i <= (NUMBER_OF_TILES + 5); i++) //5 is added to that there's room if the player is at the end of the board, and he ends up having points more than 100 (to avoid Null Pointer Exception)
		{
			Tile e = new Tile(i);
			check(i, e);
			BOARD_MAP.put(i, e);
